...
DoublyRepo.LinkedList = function() {
  // @Alternative to newing an Object up:
  var listNode = Object.create(DoublyRepo.Node.prototype);
  DoublyRepo.Node.call(listNode, 'head');
  this.head = listNode;
};
...
DoublyRepo.LinkedList.prototype.insert = function(newElement, item) {
  var newNode = DoublyRepo.instantiator(DoublyRepo.Node, newElement);
...
DoublyRepo.instantiator = function(object, args) {
  context = Object.create(object.prototype);
  object.call(context, args);
  return context;
};
...
DoublyRepo.LinkedListService = (function() {
  return function(dataSource) {
    // Instantiation
    var cities = DoublyRepo.instantiator(DoublyRepo.LinkedList);
